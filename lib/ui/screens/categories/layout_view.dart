...
class _CategoriesState extends State<Categories> {
  late ScrollController _scrollController; //Scroll controller for contents
  late ScrollController _listscrollController; //Scroll controller for title
  ...
  ///Calculate height of each category in body
  ...
  ///function When the vertical scroll is changed, adjust the horizontal scroll accordingly
  void _scrollListener() {
    double offset = _scrollController.offset;
    _listscrollController.jumpTo(offset / 3);
  ...
  ///Function to scroll to correct category in the body
